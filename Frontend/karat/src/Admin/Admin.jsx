...
const Admin = () => {
  ...
  getUser()
    ...
    const getUser = async()=>{
      const res = await axios.get("https://viraj-karat-backend.vercel.app/products")
      setData(res.data)
    }
    console.log(data)
    const handleDelete= async(id) =>{
     if(window.confirm("Are you sure that you wanted to delete that Product")){
      const res = await axios.delete(`https://viraj-karat-backend.vercel.app/products/delete/${id}`)
