...
export const getProducts =
  ...
  (dispatch) => {
    ...
    axios
      .get("https://viraj-karat-backend.vercel.app/products", param)
      .then((res) => {
  ...
  export const fetchCartData = (userID) => {
    return async (dispatch) => {
      try {
        const { data } = await axios.get(`https://viraj-karat-backend.vercel.app/products/cart?userID=${userID}`);
  ...
  export const deleteCartItem = (productId) => {
    return async (dispatch) => {
      try {
        await axios.delete(`https://viraj-karat-backend.vercel.app/products/cart/delete/${productId}`);
