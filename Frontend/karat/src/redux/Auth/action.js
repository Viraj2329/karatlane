...
export const handleUserRegister = (userData) => async (dispatch) => {
  ...
  try {
    axios
      .post("https://viraj-karat-backend.vercel.app/users/register", userData)
      .then((res) => {
        if (res.status == 200) {
...
export const handleUserLogin = (userData) => async (dispatch) => {
  ...
  try {
    axios
      .post("https://viraj-karat-backend.vercel.app/users/login", userData)
      .then((res) => {
        if (res.data.token) {
...
export const handleUserPayment = (userDiliveryAddress) => async (dispatch) => {
  ...
  try {
    axios
      .post(
        "https://viraj-karat-backend.vercel.app/order/add",
        userDiliveryAddress
      )
