...
const SingleProduct = () => {
  ...
  const getUser = async()=>{
    ...
    const res = await axios.get(`https://viraj-karat-backend.vercel.app/products/${id}`)
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://viraj-karat-backend.vercel.app/cart/add', cartData);
